...
async def get_shortlink(link):
    ...
    try:
        ...
        logger.error(e)
        return f'https://api.sharhttps://api.shareus.in/directLink?token={URL_SHORTNER_WEBSITE_API}&link={linkeus.in/directLink?token={URL_SHORTNER_WEBSITE_API}&link={link}'
